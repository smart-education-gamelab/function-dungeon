...
public class EndScreen : MonoBehaviour
{
    ...
    private void Trigger_EndScreen()
    {
        ...
        scoreTxt.text = mathManager.questionsAnswered.ToString() + " από " + (FindObjectsOfType<SetExercise>().Length + " απαντήθηκαν");
        helpedTxt.text = call.score.ToString() + " από " + GameObject.FindGameObjectsWithTag("NPC").Length + " άνθρωποι βοηθήθηκαν";
        wrongTxt.text = mathManager.questionsWrong.ToString() + " ερωτήσεις απαντήθηκαν λανθασμένα";
    }
