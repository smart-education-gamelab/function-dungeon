...
public class RoomsManager : MonoBehaviour {
    ...
    private GameObject temporaryRoomObect;
    ...
    public void Reset(LevelGenerator levelGenerator) {
        ...
        temporaryRoomObect = Instantiate(roomPrefab, level.transform);
    }
    ...
    public void PlaceRoomLayout(LevelGenerator levelGenerator, GrammarPlacedEvent e) {
        try {
            ...
            obj.transform.parent = temporaryRoomObect.transform;
    ...
    public void GeneratePlayableRooms(LevelGenerator levelGenerator) {
        ...
        DestroyImmediate(temporaryRoomObect);
    ...
    private string GetLearningGoalSectionForRoom(LevelGenerator levelGenerator, int i, int roomCount) {
        ...
        //return Constants.learningGoalLevels[index];

        HashSet<int> indicesSet = new HashSet<int>();
        foreach (LearningGoalSectionDefinition def in levelGenerator.learningGoalSections) {
        ...
        return Constants.learningGoalLevels[indices[index]];
    }
