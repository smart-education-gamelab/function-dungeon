...
public class LevelGeneratorEditor : Editor {
    ...
    private ReorderableList listAlphabet, listRecipes, learingGoalSectionsList;
    ...
    void OnEnable() {
        ...
        learingGoalSectionsList = new ReorderableList(generator.learningGoalSections, typeof(LearningGoalSectionDefinition), true, true, true, true);
        learingGoalSectionsList.drawElementCallback = LearningGoalsDrawElement;
        learingGoalSectionsList.drawHeaderCallback = LearningGoalsDrawHeader;
    }

    public override void OnInspectorGUI() {
        LevelGenerator generator = (LevelGenerator)target;
        if (GUILayout.Button("Generate")) {
            generator.Generate((int)Time.time, true);
        }
    ...
    private void LearningGoalsDrawElement(Rect rect, int index, bool active, bool focused) {
        LevelGenerator generator = (LevelGenerator)target;
        ...
        LearningGoalSectionDefinition def = generator.learningGoalSections[index];
    ...
    private void LearningGoalsDrawHeader(Rect rect) {
