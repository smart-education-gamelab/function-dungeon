    ...
    public class ReorderableList {
		...
		*/
                ...
                case EventType.KeyDown:
                    ...
                    if (GUIUtility.keyboardControl == controlID) {
                        ...
                        if (evt.keyCode == KeyCode.DownArrow && !dragging) {
                            ...
                            onSelectCallback(this); //Changed by Function Dungeon developer to fix issue with selection not changing on using the arrow keys.
                            evt.Use();
        ...
        private void DoSelection(int index, bool setKeyboardControl, Event evt) {
            ...
            //if (setKeyboardControl) { //Changed by Function Dungeon dev to fix issue with custom tooling.
            if (true) {
                GUIUtility.keyboardControl = controlID;
            }
